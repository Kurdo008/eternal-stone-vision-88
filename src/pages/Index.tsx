...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sage-50 to-moss-50">
      ...
      <section className="relative py-16 md:py-20 px-4 nature-gradient text-white overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <p className="text-base md:text-lg lg:text-xl mb-6 md:mb-8 max-w-2xl mx-auto text-sage-100 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center animate-fade-in">
            <Button 
              size="lg" 
              className="bg-white hover:bg-sage-50 text-sage-800 font-semibold px-6 md:px-8 py-3 md:py-4 text-base md:text-lg border-none"
              asChild
            >
              <Link to="/products">
                Bekijk Collectie <ArrowRight className="ml-2 h-4 md:h-5 w-4 md:w-5" />
              </Link>
            </Button>
            <Button 
              size="lg" 
              className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-sage-700 px-6 md:px-8 py-3 md:py-4 text-base md:text-lg"
              asChild
            >
      ...
      <section className="py-16 md:py-20 px-4 bg-gradient-to-br from-white to-sage-50">
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
            <div>
              ...
              <p className="text-sm md:text-base lg:text-lg text-sage-600 mb-6 md:mb-8">
              ...
              <ul className="space-y-2 md:space-y-3 lg:space-y-4 mb-6 md:mb-8">
                <li className="flex items-center text-sage-700 text-xs md:text-sm lg:text-base">
            ...
            <div className="bg-gradient-to-br from-sage-50 to-white p-3 md:p-4 lg:p-6 rounded-xl shadow-lg">
      ...
      <section className="py-16 md:py-20 px-4 bg-gradient-to-br from-moss-50 to-sage-100">
        <div className="container mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-sage-700 mb-4">
              Waar Ambacht & Natuur Samenkomen
            </h2>
            <p className="text-base md:text-lg lg:text-xl text-sage-600 max-w-2xl mx-auto">
            ...
            {craftFeatures.map((feature, index) => (
              <Card key={index} className="text-center hover:shadow-lg transition-shadow duration-300 border-2 hover:border-sage-300/50 bg-white/80 backdrop-blur-sm">
                <CardContent className="p-3 md:p-6 lg:p-8">
                  <div className="bg-sage-100 w-10 h-10 md:w-12 md:h-12 lg:w-16 lg:h-16 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4 lg:mb-6">
                    <feature.icon className="h-5 w-5 md:h-6 md:w-6 lg:h-8 lg:w-8 text-sage-600" />
                  </div>
                  <h3 className="text-xs md:text-lg lg:text-xl font-semibold text-sage-700 mb-1 md:mb-2 lg:mb-3">{feature.title}</h3>
                  <p className="text-xs md:text-sm lg:text-base text-sage-600">{feature.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      {/* Memorial Gallery */}
      <section className="py-16 md:py-20 px-4 bg-gradient-to-br from-sage-50 to-moss-50">
        <div className="container mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-sage-700 mb-4">
              ...
              <Card key={index} className="overflow-hidden border-2 hover:border-sage-300/50 transition-colors group bg-white/80 backdrop-blur-sm">
                <div className="aspect-square bg-gradient-to-br from-sage-100 to-sage-200 relative overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <item.icon className="h-12 w-12 md:h-16 md:w-16 lg:h-20 lg:w-20 text-sage-500 group-hover:text-sage-600 transition-colors" />
                  </div>
                </div>
                <CardContent className="p-3 md:p-4 lg:p-6">
                  <h3 className="text-sm md:text-lg lg:text-xl font-semibold text-sage-700 mb-2 md:mb-3">{item.title}</h3>
                  <p className="text-xs md:text-sm lg:text-base text-sage-600">{item.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
            <div className="space-y-4 md:space-y-6">
              <div className="flex items-start space-x-4">
                <div className="bg-sage-600 p-2 md:p-3 rounded-lg">
                  <MapPin className="h-4 w-4 md:h-5 md:w-5 lg:h-6 lg:w-6 text-white" />
                </div>
                <div>
                  <h3 className="text-base md:text-lg lg:text-xl font-semibold text-sage-700 mb-1 md:mb-2">Adres</h3>
                  <p className="text-xs md:text-sm lg:text-base text-sage-600">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-base md:text-lg lg:text-xl font-semibold text-sage-700 mb-1 md:mb-2">Openingstijden</h3>
                  <p className="text-xs md:text-sm lg:text-base text-sage-600">
                    Ma-Vr: 9:00 - 17:00<br />
                    Za: 10:00 - 16:00<br />
                    Zo: Gesloten
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-sage-600 p-2 md:p-3 rounded-lg">
                  <Phone className="h-4 w-4 md:h-5 md:w-5 lg:h-6 lg:w-6 text-white" />
                </div>
                <div>
                  <h3 className="text-base md:text-lg lg:text-xl font-semibold text-sage-700 mb-1 md:mb-2">Contact</h3>
                  <p className="text-xs md:text-sm lg:text-base text-sage-600">
            ...
            <div className="bg-white p-4 md:p-6 lg:p-8 rounded-xl shadow-lg">
              <div className="aspect-video bg-gradient-to-br from-sage-100 to-sage-200 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  <MapPin className="h-8 w-8 md:h-12 md:w-12 lg:h-16 lg:w-16 text-sage-600 mx-auto mb-2 md:mb-4" />
                  <p className="text-xs md:text-sm lg:text-base text-sage-600">Interactieve kaart wordt hier geladen</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-16 md:py-20 px-4 bg-gradient-to-br from-forest-600 to-forest-700 text-white">
        <div 
        ...
        ></div>
        <div className="container mx-auto text-center relative z-10">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6">Niet Gevonden Wat U Zoekt?</h2>
          <p className="text-base md:text-lg lg:text-xl mb-6 md:mb-8 max-w-2xl mx-auto text-forest-100">
